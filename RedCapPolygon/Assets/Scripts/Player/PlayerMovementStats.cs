...
public class PlayerMovementStats : ScriptableObject
{
    ...
    [Range(0.01f, 5f)] public float GravityOnReleaseMutliplier = 2f;
    ...
    public float AdjustedJumpVelocity { get; private set; }
    ...
    {
        AdjustedJumpVelocity = JumpHeight * JumpHeightCompensationFactor;
        Gravity = -(2f * AdjustedJumpVelocity) / Mathf.Pow(TimeTillJumpApex, 2f);
